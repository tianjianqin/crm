...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $(".userAvatar").attr("src",$(".userAvatar").attr("src").split("statics/images/")[0] + "statics/images/" + window.sessionStorage.getItem('userFace').split("statics/images/")[1]);
    }else{
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">在使用CRM系统如遇到困难请联系管理员，避免给您造成不必要的困扰，尽请谅解，谢谢。</p></pclass></p></div>',
