layui.use(['form','layer','table','laytpl'],function(){
    ...
    //分配客户给销售
    $(".distribute_sale").click(function(){
        ...
        if(data.length > 0) {
            ...
            layer.confirm('确定要给当前销售分配客户？', {icon: 3, title: '提示信息'}, function (index) {
                $.ajax({
                    type : 'post',
                    url : '/custominfo/distributeSale',
                    dataType : 'json',
                    traditional: true,
            ...
            layer.msg("请选择需要分配的销售员");
        }
    })

    // function distributeConsult(){
    //     var index = layui.layer.open({
    //         // type : 2,
    //         content : "distribute_consult.html",
    //     })
    ...
    $(".distribute_consult").click(function(){
        // distributeConsult();
        location.href = "distribute_consult.html";
    })
